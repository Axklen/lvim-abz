...
M.config = function()
  ...
  -- copilot shortcuts
  lvim.keys.normal_mode["<F2>"] = "<cmd>Copilot enable<cr>"
  lvim.keys.normal_mode["<F3>"] = "<cmd>Copilot disable<cr>"
  lvim.keys.insert_mode["<F2>"] = "<cmd>Copilot enable<cr>"
  lvim.keys.insert_mode["<F3>"] = "<cmd>Copilot disable<cr>"
